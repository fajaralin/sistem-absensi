                    ...
                    @forelse($students as $st)
                        <tr class="hover:bg-slate-50/45 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                ...
                                @if($st->parent_email)
                                    <span class="text-[10px] text-blue-500 font-semibold mt-1 block" title="Email Orang Tua">📧 {{ $st->parent_email }}</span>
                                @else
                                    <span class="text-[10px] text-slate-400 font-semibold mt-1 block">📧 Belum ada email ortu</span>
                                @endif
                            </td>
